/**
 * The label/description chrome the three actions widgets share.
 *
 ...
 * `actions-block.css` is scope-wrapped to `.aurora-editor`,
 ...
 * `actions-*-widget` classes are ours, for a hook that never depends on
